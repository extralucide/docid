...
##        print "Release lock.\n"
    ...
    def __init__(self,
        ...
        swrd                        = tool.getOptions("Lifecycle","swrd")
        is_swrd                     = tool.getOptions("Lifecycle","is_swrd")
        swdd            = tool.getOptions("Lifecycle","swdd")
        is_swdd         = tool.getOptions("Lifecycle","is_swdd")
        shlvcp          = tool.getOptions("Lifecycle","shlvcp")
        self.dir_swrd   = join(self.root_user_dir,swrd)
        self.is_swrd    = join(self.dir_swrd,is_swrd)
...
##                    self.__loadConfig()
                    ...
                    enable_bproc_parsing = self.queue.get(3)
                    self.send_cmd_thread = threading.Thread(None,self._checkSHLVCP,None,(dirname_shlvcp,dirname_swrd,enable_bproc_parsing))
                    self.send_cmd_thread.start()
                    ...
                    stack = Stack(master=self.master_ihm)
...
##                print list_wo_doublons_2
    ...
    def _checkSHLVCP(self,
        ...
        shlvcp = Shlvcp(callback = self.master_ihm.log)
    ...
    def _buildSCOD(self,
        ...
        if wb is not None:
            ...
            if ws is not None:
                ...
                wb.save(join("result",filename))
                #self.master_ihm.resultHyperLink(filename,text="SCOD created.")
                if filename is not None and self.master_ihm :
                    self.master_ihm.resultGenerateCID(filename,
                                                False,
